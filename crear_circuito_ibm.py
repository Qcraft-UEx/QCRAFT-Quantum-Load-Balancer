...
# Método para usar la api que se ocupa de transpilar el circuito de formato gráfico al lenguaje de IBM.
def crear_circuito_ibm_api(circuito):

    # Url donde vamos a hacer la llamada.
    url = "http://quantumservicesdeployment.spilab.es:8081/code/ibm"
